			...
			<div class="wrapper">
				<table>
					<tr>
						<th>회원번호(자동발생)</th>
						<td>
							<input type="text" name="custno" value="<%=m.getCustno()%>" readonly />
					...
					<tr>
						<th>회원성명</th>
						<td>
							<input type="text" name="custname" value="<%=m.getCustname() %>" />
						</td>
					</tr>
					<tr>
						<th>회원전화</th>
					...
					<tr>
						<th>회원주소</th>
						<td>
							<input type="text" name="address" value="<%=m.getAddress() %>" />
						</td>
					</tr>
					<tr>
						<th>가입일자</th>
						<td>
							<input type="text" name="joindate" value="<%=m.getJoindate() %>" />
						</td>
					</tr>
					<tr>
						<th>고객등급[A:VIP, B:일반, C:직원]</th>
						<td>
							<input type="text" name="grade" value="<%=m.getGrade() %>" />
						</td>
					</tr>
					<tr>
						<th>도시코드</th>
